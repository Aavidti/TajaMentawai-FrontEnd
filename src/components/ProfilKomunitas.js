	...
	return (
		<div>
			...
			<div style={{width:'100%',height:'350px'}} class="position-relative">
				<img src="/surfing_bg.jpg" style={{width:'100%',height:'100%',objectFit:'cover'}}/>
				<div style={{position:'absolute',top:'0',background:'#00000033',width:'100%',height:'100%'}}></div>
			</div>
			<div class="container position-relative d-flex gap-4" style={{height:"80vh"}}>
				<div style={{padding:'30px 30px',borderRadius:'10px',top:'-50px',background:'white'}} class="shadow col-4 position-absolute">
				...
				<div style={{padding:'30px 30px',borderRadius:'10px',background:'white',right:'0',marginTop:'40px'}} class="shadow col-7 position-absolute">
