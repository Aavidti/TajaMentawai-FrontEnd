	...
	return (
		<div>
			...
			<div class="container d-flex flex-column" style={{gap:'20px',marginTop:'50px',marginBottom:'100px'}}>
				<div class="d-flex gap-4 align-items-center p-4 shadow col-12" style={{borderRadius:'20px'}}>
					<div>
					...
					<div style={{width:'100%'}}>
						...
						<div class="d-flex justify-content-around mt-3">
							<div class="d-flex align-items-center gap-2">
								<img src="/ask-q.webp" style={{width:'24px',height:'24px'}}/>
								Tanya
							</div>
							<div class="d-flex align-items-center gap-2">
								<img src="/share.webp" style={{width:'24px',height:'24px'}}/>
								Kirim
							</div>
						</div>
					</div>
				...
				<div style={{padding:'30px 30px',borderRadius:'10px',background:'white',right:'0',marginTop:'10px'}} class="shadow">
					...
					<div>
						...
						{openKomen && <div>
							<div class="mt-5"><b>Komentar</b></div>
							<div class="d-flex gap-2 align-items-center mt-5">
								...
								<div>
									<div class="d-flex align-items-center gap-2">
										<div><b>Adel Jasmen</b></div>
										<div>12/09/24</div>
									</div>
								</div>
							</div>
							<div class="ml-3 mt-2" style={{marginLeft:'40px'}}>Keren bangett....</div>
						</div>
						}
					</div>
				</div>
