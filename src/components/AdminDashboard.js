      ...
      <div style={{
        ...
        <div style={{display:'flex',flexDirection:'column',justifyContent:'space-between',height:'100%'}}>
          ...
          <div>
            ...
            <a href="/admin/login" style={{textDecoration:'none',color:'black'}}>
              <div style={{
                display:'flex',justifyContent:'center',borderLeft:'5px solid white',marginBottom:'3px'
              }}>
                <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div class="d-flex justify-content-between">
            <div style={{width:'400px',background:'white',padding:'20px 30px',borderRadius:'20px'}}>
              <div style={{
                ...
                <div>
                  <img src="/dashboard_user_icon.png" style={{width:'64px'}}/>
                </div>
              </div>
              <div style={{display:"flex",gap:'5px',fontWeight:'bold',marginTop:'20px',alignItems:'center'}}>
                <div>
            ...
            <div style={{width:'400px',background:'white',padding:'20px 30px',borderRadius:'20px'}}>
              <div style={{
                ...
                <div>
                  <img src="/dashboard_yellow_icon.png" style={{width:'64px'}}/>
                </div>
              </div>
              <div style={{display:"flex",gap:'5px',fontWeight:'bold',marginTop:'20px',alignItems:'center'}}>
                <div>
            ...
            <div style={{width:'400px',background:'white',padding:'20px 30px',borderRadius:'20px'}}>
              <div style={{
                ...
                <div>
                  <img src="/dashboard_purple_icon.png" style={{width:'64px'}}/>
                </div>
              </div>
              <div style={{display:"flex",gap:'5px',fontWeight:'bold',marginTop:'20px',alignItems:'center'}}>
                <div>
                  <img src="/dashboard_down_icon.png" style={{width:'32px'}}/>
                </div>
                <div>
                  4.3 %
                </div>
