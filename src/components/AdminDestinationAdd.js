          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <img src="/destination_white_icon.png" style={{width:'24px'}}/>
                <div>Destinasi</div>
              </div>
            </div>
            <div style={{
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <h3 className="card-title mb-0">Tambah Destinasi</h3>
                  <div className="d-flex gap-2">
                    <a href="/admin/destination" style={{textDecoration:'none'}}>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label className="form-label fw-semibold">Destinasi</label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label className="form-label fw-semibold">Fasilitas</label>
                        <input
                          type="text"
                          className="form-control"
